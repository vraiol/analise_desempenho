...
try:
    ...
    if p_value < significancia:
        ...
        print("Não rejeitamos a hipótese nula, indicando que não há evidências suficientes para afirmar que há uma diferença significativa entre os tempos de execução dos algoritmos")
